...
--
-- Host: localhost
-- Generation Time: Feb 10, 2015 at 09:45 PM
...
CREATE TABLE IF NOT EXISTS `clock` (
  ...
  PRIMARY KEY (`clockID`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 COMMENT='For logging job and user hours' AUTO_INCREMENT=0 ;
...
INSERT INTO `job` (`JobID`, `JobFkClientID`, `JobFromFkUserID`, `JobToFkUserID`, `JobParent`, `JobChild`, `JobBranch`, `JobDate`, `JobType`, `JobTitle`, `JobPriority`, `JobImpUrg`, `JobStatus`, `JobDescription`, `JobCardNumber`, `JobSchedTimeInSecs`, `JobEstSecs`, `JobActualSecs`, `JobTimeComment`, `JobTimeInserted`, `JobParts`) VALUES (1, 1, 1, 1, 0, 0, 0, '', 'WorkShop', 'Example Job or Task.', 53, '0', 'Active', 'Example', '', 1423229460, 60, 0, '', '1423229492', '');
...
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 COMMENT='User Information' AUTO_INCREMENT=3 ;
...
(1, 0, 'Australia/Sydney', 1, 1421407111, 'dion', 30240, 'Kanton@@', 'user', '', 'Dion', '', '', '', '', '', '', '', '', '', '', '7rocks.com');
INSERT INTO `user` (`UserID`, `UserFkClientID`, `user_time_zone`, `UserActive`, `UserDate`, `UserLogin`, `User_db_token`, `UserPassword`, `UserType`, `UserLastname`, `UserFirstname`, `UserAddress1`, `UserAddress2`, `UserCity`, `UserState`, `UserPostcode`, `UserCountry`, `UserPhone1`, `UserPhone2`, `UserFax`, `UserEmail`, `UserUrl`) VALUES (2, 0, 'Australia/Sydney', 0, 1421407111, 'everyone', 30240, 'Kanton@@', 'user', '', 'Everyone', '', '', '', '', '', '', '', '', '', '', '7rocks.com');
